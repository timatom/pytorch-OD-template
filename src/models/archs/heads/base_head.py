...
class BaseHead(nn.Module, metaclass=ABCMeta):
    def __init__(self, input_shape, *args, **kwargs):
        '''
        Initialize the BaseHead component. 
        Args:
    ...
    def forward(self, inputs):
        '''
        Forward pass. Apply the head on the input tensor.
        To be implemented by subclasses.
        Args:
            inputs (torch.Tensor): Input tensor. It should be of the form (batch_size, channels, height, width).
                                   The input tensor is the output of the Neck component.
        Returns:
            torch.Tensor: Output tensor. Its shape should be compatible with the Loss component.
        '''
        pass
    ...
    def get_output_shape(self):
        ...
        Returns:
            tuple: Output shape of the model. It should be of the form (batch_size, channels, height, width).
                   ...
                   It is used to determine the input shape of the Loss component.
        '''
        pass